...
async function obtenerResidentes() {
    const res = await gapi.client.sheets.spreadsheets.values.get({
        ...
        // CORREGIDO: El rango ahora lee hasta la columna M para incluir los datos del convenio.
...
// NUEVO: Función para actualizar específicamente el saldo del convenio en la columna M.
async function actualizarSaldoConvenioEnSheet(rowNumber, nuevoSaldo) {
    ...
    await gapi.client.sheets.spreadsheets.values.update({
        spreadsheetId: SPREADSHEET_ID,
        range: `${SHEET_RESIDENTES}!M${rowNumber}`, // Actualiza solo la celda en la columna M
        valueInputOption: 'USER_ENTERED',
...
// MODIFICADO: El rango de Pagos_GC ahora lee hasta la columna R para incluir el abono a convenio.
