            ...
            <div class="modal-content">
                ...
                <form id="formResidente">
                    ...
                    <div style="display:flex; flex-wrap:wrap; gap:15px;">
                        ...
                        <div style="flex: 1 1 120px; max-width: 150px;"><label>RUT</label><input type="text" id="rut"></div>
                        <div style="flex: 0 1 100px; max-width: 110px;"><label>N° Parcela</label><input type="number" id="parcela" required></div>
                        <div style="flex: 1 1 250px;"><label>Email</label><input type="email" id="email"></div>
                        <div style="flex: 1 1 120px; max-width: 140px;"><label>Teléfono</label><input type="text" id="telefono"></div>
                        <div style="flex: 0 1 120px; max-width: 130px;"><label>Estado</label><select id="estado"><option>Activo</option><option>Inactivo</option><option>Moroso</option></select></div>
                        <div style="flex: 1 1 150px; max-width: 160px;"><label>Valor GC</label><input type="number" id="valorGC"></div>
                    </div>
